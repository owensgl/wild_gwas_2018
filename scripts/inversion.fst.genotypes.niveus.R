...
directory <- "Niveus.tranche90.snp.gwas.90.bi.500.mdsoutlierfst.calls"
base_directory <- "/media/owens/Copper/wild_gwas_2018/niveus"
labels <- read_tsv("/home/owens/working/sample_info_apr_2018.tsv",col_names = T)
prefix <- "Niveus.tranche90.snp.gwas.90.bi.500.all"
