...
#Plotting PCAs
pdf("Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.pca.pdf",height=6,width=14)
for (i in seq(1,20,2)){
  j <- i +1
...
write_tsv(tab, "Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.pca.txt")
...
pdf("Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.pca.loadings.pdf")
for (i in 1:20){
...
write_delim(selected_snps, "Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.txt")
...
pdf("Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.kinship.pdf")
...
write_delim(ibd.dat, "Petiolaris.tranche90.snp.petpet.90.bi.ldr0p2.kinship.txt")
...
gds.file <- "Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.gds"
vcf.file <- "Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.vcf.gz"
...
write(pca$eigenval, "Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.eigenvalues.txt",
      ncol=length(pca$eigenval))


write.table(pca$eigenvect, "Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.eigenvectors.txt",
...
#Plotting PCAs
pdf("Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.pca.pdf",height=6,width=14)
for (i in seq(1,20,2)){
  j <- i +1
  tab <- data.frame(name = pca$sample.id,
                    EV1 = pca$eigenvect[,i],  
...
write_tsv(tab, "Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.pca.txt")
