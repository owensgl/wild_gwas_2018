...
pet29.30 <- read_tsv(paste(directory,"/Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.pet29pet30.fst.txt.gz",sep=""))
pet29.30$comparison <- "pet29.30"

pet29.31 <- read_tsv(paste(directory,"/Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.pet29pet31.fst.txt.gz",sep=""))
pet29.31$comparison <- "pet29.31"

pet30.31 <- read_tsv(paste(directory,"/Petiolaris.tranche90.snp.petpet.90.bi.remappedHa412HO.pet30pet31.fst.txt.gz",sep=""))
...
fst <- rbind(pet29.30,pet29.31, pet30.31)

window_size <- 1000000
pdf("Pet_30_fst.v2.pdf",height=8,width=12)
