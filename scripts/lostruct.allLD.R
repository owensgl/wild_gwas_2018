...
for (i in sprintf("%02d", seq(17))){
  ...
  ld <- read_tsv(paste("/media/owens/Copper/wild_gwas_2018/argophyllus/Argophyllus.tranche90.snp.gwas.90.bi.remappedHa412HO.thin1k.maf5.Chr",i,".windows.ld.gz",sep=""))
  window_size <- 500000
  ld %>%
    mutate(percent_above_20 = r2_min_0.2/n) %>%
