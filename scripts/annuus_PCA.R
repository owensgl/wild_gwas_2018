...
gds.file <- "Annuus.tranche99.snp.gwas.90.bi.gds"
vcf.file <- "Annuus.tranche99.snp.gwas.90.bi.vcf.gz"
...
#Plotting PCAs
pdf("Annuus.tranche99.snp.gwas.90.bi.ldr0p2.pca.pdf",height=6,width=14)
for (i in seq(1,20,2)){
  j <- i +1
...
write_tsv(tab, "Annuus.tranche99.snp.gwas.90.bi.ldr0p2.pca.txt")
...
pdf("Annuus.tranche99.snp.gwas.90.bi.ldr0p2.pca.loadings.pdf")
for (i in 1:20){
...
write_delim(selected_snps, "Annuus.tranche99.snp.gwas.90.bi.ldr0p2.txt")
...
pdf("Annuus.tranche99.snp.gwas.90.bi.ldr0p2.kinship.pdf")
...
write_delim(ibd.dat, "Annuus.tranche99.snp.gwas.90.bi.ldr0p2.kinship.txt")
