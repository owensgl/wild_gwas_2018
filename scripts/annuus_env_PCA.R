...
folder <- "/media/owens/Copper/wild_gwas_2018/annuus/"
gds.file <- "Annuus.tranche99.snp.env.90.bi.gds"
vcf.file <- "Annuus.tranche99.snp.env.90.bi.vcf.gz"
...
#Plotting PCAs
pdf("Annuus.tranche99.snp.env.90.bi.ldr0p2.pca.pdf",height=4,width=14)
for (i in seq(1,20,2)){
  j <- i +1
...
write_tsv(tab, "Annuus.tranche99.snp.env.90.bi.ldr0p2.pca.txt")
...
pdf("Annuus.tranche99.snp.env.90.bi.ldr0p2.pca.loadings.pdf")
for (i in 1:20){
...
write_delim(selected_snps, "Annuus.tranche99.snp.env.90.bi.ldr0p2.txt")
...
pdf("Annuus.tranche99.snp.env.90.bi.ldr0p2.kinship.pdf")
...
write_delim(ibd.dat, "Annuus.tranche99.snp.env.90.bi.ldr0p2.kinship.txt")
...
folder <- "/media/owens/Copper/wild_gwas_2018/annuus/"
gds.file <- "Annuus.tranche90.snp.env.90.bi.remappedHa412HO.noinv.gds"
vcf.file <- "Annuus.tranche90.snp.env.90.bi.remappedHa412HO.noinv.vcf.gz"
snpgdsVCF2GDS(paste(folder,vcf.file,sep="/"), paste(folder,gds.file,sep="/"), method="biallelic.only", ignore.chr.prefix = "HanXRQChr")
