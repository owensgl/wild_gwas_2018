...
directory <- "Argophyllus.tranche90.snp.gwas.90.bi.500.mdsoutlierfst.calls"
base_directory <- "/media/owens/Copper/wild_gwas_2018/argophyllus"
labels <- read_tsv("/home/owens/working/sample_info_apr_2018.tsv",col_names = T)
prefix <- "Argophyllus.tranche90.snp.gwas.90.bi.500.all"
