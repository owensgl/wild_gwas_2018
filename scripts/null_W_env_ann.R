...
for (x in 1:nrow(ann_inversion_list)){
  chosen_chr <- ann_inversion_list$chr[x]
  chosen_mds <- ann_inversion_list$mds[x]
  chosen_windows <- ann_inversions_length %>% filter(chr == chosen_chr, mds == chosen_mds) %>% pull(length)
...
pdf("var_out_annuus_2018_HA412_maf_0.03_all_covariates_BayPass_IS_STD.null_w.pdf")
inv_p_scores %>%
...
pdf("var_out_annuus_2018_HA412_maf_0.03_all_covariates_BayPass_IS_STD.null_w.hist.pdf")
hist(inv_p_scores$empirical_p)
dev.off()

write_tsv(perm_z_scores, "var_out_annuus_2018_HA412_maf_0.03_all_covariates_BayPass_IS_STD.null_w.perm.txt")
write_tsv(inv_z_scores, "var_out_annuus_2018_HA412_maf_0.03_all_covariates_BayPass_IS_STD.null_w.inv_z.txt")
write_tsv(inv_p_scores, "var_out_annuus_2018_HA412_maf_0.03_all_covariates_BayPass_IS_STD.null_w.txt")
