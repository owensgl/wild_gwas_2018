...
intrachr_r <- read_tsv("/media/owens/Copper/wild_gwas_2018/niveus/Niveus.tranche90.snp.gwas.90.bi.reduced.geno.ld")

pdf("Niveus.tmp.pet.snp.bi.90.filtered.reduced.geno.ld.v1.pdf",height=10,width=10)
...
###Interchromosome
interchr_r <- read_tsv("/media/owens/Copper/wild_gwas_2018/niveus/Niveus.tranche90.snp.gwas.90.bi.reduced.interchrom.geno.ld")
interchr_r %>% rename(r2 = `R^2`,chr1 = CHR1, pos1 = POS1, chr2 = CHR2, pos2 = POS2) -> interchr_r

chrs <- c("HanXRQChr03","HanXRQChr06","HanXRQChr10")

pdf("Niveus.tmp.pet.snp.bi.90.filtered.reduced.geno.interld.v1.pdf",height=10,width=10)
