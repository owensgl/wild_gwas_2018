...
directory <- "Petiolaris.tranche90.snp.petfal.90.bi.500.mdsoutlierfst.calls"
base_directory <- "/media/owens/Copper/wild_gwas_2018/petfal"
labels <- read_tsv("/home/owens/working/sample_info_apr_2018.tsv",col_names = T)
prefix <- "Petiolaris.tranche90.snp.petfal.90.bi.500.all"
