...
data_directory <- "/media/owens/Copper/wild_gwas_2018/anomalus/"
data_name <- "Anomalus.tranche90.snp.gwas.90.bi"
...
target_state <- subset(states, region %in% c("utah"))
lat_range <- c(36.5, 42.1)
long_range <- c(-115,-108.8)
pie_size <- 0.4
