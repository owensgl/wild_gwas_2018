...
bcftools view --threads 10 -R /scratch/gowens/wild_gwas/wild_gwas_2018/Ha412HO.chrlist.bed -O v $capital_species.$prefix.$pop.remappedHa412.vcf.gz  | perl /scratch/gowens/pop_gen/vcf2ibd_dist.pl > /scratch/gowens/wild_gwas/wild_gwas_2018/Inv_ibd/Ha412HO/$git_species/$capital_species.$prefix.$pop.remappedtarget.multispecies.ibd.txt
...
rm $capital_species.$prefix.$pop.remappedHa412.vcf.gz*
