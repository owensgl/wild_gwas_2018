library(tidyverse)
library(viridis)
intrachr_r <- read_tsv("/media/owens/Copper/wild_gwas_2018/petfal/Petiolaris.tranche90.snp.petfal.90.bi.reduced.geno.ld")

pdf("Petiolaris.tranche90.snp.petfal.90.bi.reduced.geno.ld.v1.pdf",height=10,width=10)
...
###Interchromosome
interchr_r <- read_tsv("/media/owens/Copper/wild_gwas_2018/petfal/Petiolaris.tranche90.snp.petfal.90.bi.reduced.interchrom.geno.ld")
interchr_r %>% rename(r2 = `R^2`,chr1 = CHR1, pos1 = POS1, chr2 = CHR2, pos2 = POS2) -> interchr_r

chrs <- c("HanXRQChr05","HanXRQChr09","HanXRQChr11", "HanXRQChr14")

pdf("Petiolaris.tranche90.snp.petfal.90.bi.reduced.interchrom.geno.interld.v1.pdf",height=10,width=10)
